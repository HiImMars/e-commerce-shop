  ...
  return (
    <header className="shadow-md sticky z-50 top-0 bg-header">
      <div className="container flex justify-between items-center">
        <Link to="/">
          <h2 className="text-4xl font-bold text-grey p-4 hover:text-orange focus:text-lightBlue duration-200">
            Fake Store
          </h2>
        </Link>
        <Link
        ...
        >
          <CiShoppingCart className="text-orange h-9 w-9 stroke-1 group-hover:text-darkBlue group-focus:text-darkBlue duration-200" />
          {totalAmount > 0 && (
